...
public interface ApiServer {
    ...
    @POST
    Observable<JsonElement> postTest(@Url String url);
    ...
    @PUT
    @FormUrlEncoded
    Observable<JsonElement> put(@Url String url, @PartMap Map<String, Object> params, @HeaderMap Map<String, Object> heards);
    ...
    //下载文件
    @Streaming
    Observable<ResponseBody> download(@Url String url, @QueryMap Map<String, Observable> params, @HeaderMap Map<String, Object> heards);
}
